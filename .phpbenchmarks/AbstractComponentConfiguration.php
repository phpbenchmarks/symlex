...
abstract class AbstractComponentConfiguration
{
    ...
    {
        return [
            'route' => 'https://github.com/phpbenchmarks/symlex-common/blob/symlex_4_hello-world/src/Controller/BenchmarkController.php#L12',
            'controller' => 'https://github.com/phpbenchmarks/symlex-common/blob/symlex_4_hello-world/src/Controller/BenchmarkController.php'
        ];
    }
}
